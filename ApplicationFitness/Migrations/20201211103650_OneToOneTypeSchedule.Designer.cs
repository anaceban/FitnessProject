...
namespace ApplicationFitness.Infrastracture.Migrations
{
    ...
    [Migration("20201211103650_OneToOneTypeSchedule")]
    partial class OneToOneTypeSchedule
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationFitness.Domain.Models.ProgramAdvice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ApplicationFitness.Domain.Models.ProgramSchedule", b =>
                {
                    b.HasOne("ApplicationFitness.Domain.Models.ProgramType", "ProgramType")
                        .WithOne("ProgramSchedule")
                        .HasForeignKey("ApplicationFitness.Domain.Models.ProgramSchedule", "ProgramTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
